...
from src.codecademy_theme import (
    DANGER,
    INFO,
    POSITIVE,
    PRIMARY_YELLOW,
...
def render_role_signal(
    ...
    color = POSITIVE if tone == "positive" else DANGER if tone == "danger" else PRIMARY_YELLOW
...
def safe_table(frame: pd.DataFrame, tab_name: str, columns: list[str] | None = None) -> None:
    ...
    column_labels = {
        ...
        "creative_role": "Activation Role",
        "audience_segment": "Audience",
        "growth_motion": "Product Motion",
        "asset_id": "Asset ID",
